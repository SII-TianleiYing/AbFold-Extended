...
The initial version of AbFold can be found at its original repository [/HK-GSAS/AbFold](https://github.com/HK-GSAS/AbFold). We have introduced several minor improvements in the current release. For engineering deployment of AbDiff, we recommend using the AbFold implementation provided in this repository to ensure correct environment configuration.
